...
import (
	"errors"
	"fmt"
	go_wasi_http "github.com/unickorn/golem-poll-manager/manager_out"
	"io"
	"net/http"
	"strconv"
	"strings"
...
// because I was running into some issues with the go modules when trying to import github.com/zivergetech/go-wasi-http
